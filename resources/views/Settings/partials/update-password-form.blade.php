<section>
    <header>
        <h2 class="text-base font-semibold text-gray-900">
            {{ $user->hasUsablePassword() ? __('app.profile.password_section.title') : __('app.profile.password_section.set_title') }}
        </h2>

        <p class="mt-2 text-sm text-gray-500">
            {{ $user->hasUsablePassword() ? __('app.profile.password_section.subtitle') : __('app.profile.password_section.set_subtitle') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        @if ($user->hasUsablePassword())
            <div>
                <x-input-label for="update_password_current_password" :value="__('app.profile.password_section.current')" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('app.profile.password_section.new')" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('app.common.confirm_password')" />
